...
func (f *serviceFactory[I, S]) Initialize(ctx context.Context) error {
	if !f.singleton {
		return nil
	}
...
func (f *serviceFactory[I, S]) build(ctx context.Context) (*S, error) {
...
func (f *serviceFactory[I, S]) Instance(ctx context.Context) (any, error) {
	if f.singleton {
