...
// It uses the provided function with three arguments to create the instance.
type ServiceFactory3[T any, P1 any, P2 any, P3 any] struct {
	ServiceTyped[T]
	fn func(ctx context.Context, p1 P1, p2 P2, p3 P3) (T, error)
}

func (c *ServiceFactory3[T, P1, P2, P3]) Arguments() int {
	return 3
}
...
func (c *ServiceFactory3[T, P1, P2, P3]) Instance(ctx context.Context, args ...any) (any, error) {
	...
	instance, err := c.fn(ctx, p1, p2, p3)
	if err != nil {
		return nil, err
	}
