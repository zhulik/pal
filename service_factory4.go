...
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Dependencies() []ServiceDef {
	return nil
}

// Run is a no-op for factory services as they don't run in the background.
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Run(_ context.Context) error {
	return nil
}

// Init is a no-op for factory services as they are created on demand.
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Init(_ context.Context) error {
	return nil
}

// HealthCheck is a no-op for factory services as they are created on demand.
func (c *ServiceFactory4[T, P1, P2, P3, P4]) HealthCheck(_ context.Context) error {
	return nil
}

// Shutdown is a no-op for factory services as they are created on demand.
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Shutdown(_ context.Context) error {
	return nil
}

func (c *ServiceFactory4[T, P1, P2, P3, P4]) RunConfig() *RunConfig {
	return nil
}

// Make is a no-op for factory services as they are created on demand.
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Make() any {
	var t T
	return t
}
...
func (c *ServiceFactory4[T, P1, P2, P3, P4]) Name() string {
